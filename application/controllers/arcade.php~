...
class Arcade extends CI_Controller {
    ...
    //alerts the user of any invitations
    ...
    function acceptInvitation() {
        ...
        //declines invitation from other user and maintains game state
	...
	//checks for any invitations from other users
	...
	//invites a user wh is logged on and available for a game
	function invite() {
		try {
